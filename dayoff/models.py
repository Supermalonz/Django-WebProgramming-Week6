...
class Dayoff(models.Model):
    create_by = models.ForeignKey(User, db_column='create_by', on_delete=models.CASCADE, verbose_name='ลาโดย')
    reason = models.TextField(blank=False, null=True, verbose_name='สาเหตุ')
